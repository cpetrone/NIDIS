...
% The code requires selecting a CSV input file. This MUST be formatted in
% the same way as the output file from sister function 'grey_values'.
...
dir_number = 1;
directory_name = strcat(csvname(1:end-4), sprintf('_fit_%d', dir_number));
